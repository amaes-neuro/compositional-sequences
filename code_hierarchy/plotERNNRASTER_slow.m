...
firstInhNeuron = find(spksAll(:,1) >= EneuronNum_slow+1);
...
hold on; plot(spksInh(:,2),spksInh(:,1),'b.'); axis([0 size(rast_slow,2)/10000 1 neuronNum_slow])   %convert to seconds
set(gca,'FontSize',25)
