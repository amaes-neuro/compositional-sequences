...
T = 240;                      %Simulation in milli-seconds
...
Jex(1:EneuronNum) = Jeex;
Jex(EneuronNum+1:neuronNum) = Jiex;
...
for i =2:T/dt
    ...
    rast(idx,i) = idx;
    rast_binary(idx,i) = 1;
    forwardInputsI = forwardInputsI + [sum(weightsEI(:,idx-EneuronNum),2);sum(weightsII(:,idx-EneuronNum),2)]'; %recurrent
