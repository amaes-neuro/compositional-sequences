...
w_slow = a*(Vreset-V_E)*ones(1,EneuronNum_slow);  %adaptation vector for all exc neurons
...
%E-RNN slow
xedecay_slow = zeros(1,neuronNum_slow);
xerise_slow = zeros(1,neuronNum_slow);
xidecay_slow = zeros(1,neuronNum_slow);
xirise_slow = zeros(1,neuronNum_slow);

gE_slow = zeros(1,neuronNum_slow);
gI_slow = zeros(1,neuronNum_slow);
...
gE_syll = zeros(1,SyllIneuronNum);
gI_syll = zeros(1,SyllIneuronNum);
