...
for m=1:its
    ...
    times(1,2) = find(conv_rast_mean(11,:)==max(conv_rast_mean(11,:)));
    times(2,1) = find(conv_rast_mean(17,:)==max(conv_rast_mean(17,:)));
    times(2,2) = find(conv_rast_mean(28,:)==max(conv_rast_mean(28,:)));  
    times(3,1) = find(conv_rast_mean(34,:)==max(conv_rast_mean(34,:)));
    times(3,2) = find(conv_rast_mean(45,:)==max(conv_rast_mean(45,:)));     
